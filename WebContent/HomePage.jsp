...
<html>
  <head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="glossyfinish.css"> -->
    <link href='http://fonts.googleapis.com/css?family=Lato:300,400,700,900' rel='stylesheet' type='text/css'>
	<link rel="stylesheet" href="http://fontawesome.io/assets/font-awesome/css/font-awesome.css">
    
   <!--  <script type="text/javascript">
    ExecuteOrDelayUntilScriptLoaded(function () { $("#s4-workspace").scrollTop(0); }, 'SP.UI.RTE.Publishing.js'); 
    </script>
  -->   
  ...
  <div id="nav">
   ...
   <div id="map"></div>
    <table>
          ...
          <tr><td><input id="signup" type=button class="buttons" onClick="parent.location='http://localhost:8082/New/Signup.jsp'" value='Sign Up'></td></tr>
          <tr><td><input id="login" type=button class="buttons" onClick="parent.location='http://localhost:8082/New/Loginpage.jsp'" value='Login'></td></tr>
        </table>
